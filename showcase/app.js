...
class ClimateDashboardApp {
  ...
  initShowcaseHeader() {
    ...
    if (document.querySelector(".showcase-sidebar")) return;
    ...
    const brandEl = document.querySelector(".showcase-bar .showcase-brand");
    if (brandEl && !brandEl.querySelector(".showcase-menu-toggle")) {
      const toggleBtn = document.createElement("button");
      toggleBtn.className = "showcase-menu-toggle";
