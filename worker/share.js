...
export async function sharePage(env, request, token) {
  ...
  const desc = `${g.gradeHeadline}. Footprint ${g.footprintBandLabel.toLowerCase()}; handprint ${g.handprintStatus}; data maturity ${g.maturityLabel.toLowerCase()}. Modeled with GTR Handprint.`;
...
<div class="wrap">
  <div class="brand">◇ GTR Handprint · Climate Impact</div>
