...
export async function sharePage(env, request, token) {
  ...
  const desc = `${g.gradeHeadline}. Footprint ${g.footprintBandLabel.toLowerCase()}; handprint ${g.handprintStatus}; data maturity ${g.maturityLabel.toLowerCase()}. Modeled with Climatico.`;
...
<div class="wrap">
  <div class="brand">◇ Climatico · Climate Impact</div>
